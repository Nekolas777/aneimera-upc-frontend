export const CalendarIcon = () => {
  return (
    <svg
      className='w-9 h-9 hover:scale-105 transition-all duration-200 ease-linear'
      width='75'
      height='75'
      viewBox='0 0 75 75'
      fill='none'
    ...
    >
      <rect width='75' height='75' fill='url(#pattern0_226_141)'></rect>
      <defs>
        <pattern
          id='pattern0_226_141'
